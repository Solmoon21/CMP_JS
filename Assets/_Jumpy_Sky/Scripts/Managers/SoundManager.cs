...
namespace ClawbearGames
{
    public class SoundManager : MonoBehaviour
    {
        ...
        [SerializeField] private AudioClip normalJump = null;
        public AudioClip NormalJump { get { return normalJump; } }
        [SerializeField] private AudioClip changedColors = null;
        public AudioClip ChangedColors { get { return changedColors; } }
        [SerializeField] private AudioClip[] centerJumps = null;
        public AudioClip[] CenterJumps { get { return centerJumps; } }
        ...
        public AudioClip PlayerFallDown { get { return playerFallDown; } }
        ...
        private IEnumerator CRIncreaseVolume(float increasingTime)
        {
            ...
            while (t < increasingTime)
            {
                ...
                musicSource.volume = Mathf.Lerp(0f, 0.2f, factor);
                yield return null;
            }
        }
